...
export default function FAQSection() {
  ...
  return (
    <section
      id="faq"
      className="w-full bg-[#F5F1E9] py-9 min-[375px]:py-11 sm:py-16 lg:py-20 border-b border-[#DDD7CC]"
              ...
              return (
                <div key={item.q} className="border-b border-[#DDD7CC] last:border-b-0">
                  <button
                    type="button"
                    id={btnId}
                    className="flex min-h-[48px] sm:min-h-[54px] w-full items-center justify-between gap-3 sm:gap-6 px-4 py-3 sm:px-6 text-left transition-colors duration-150 hover:bg-[#F5F1E9]/60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#9A7538]"
