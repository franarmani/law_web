      ...
      <div className="mx-auto max-w-[1240px] px-4 sm:px-6 md:px-8 lg:px-10">
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-[1fr_1fr] lg:gap-16 xl:gap-20">
          ...
          <div>
            ...
            <blockquote className="mt-8 border-l-2 border-[#9C7737] pl-6 py-2.5 bg-[#F5F1E9]/60">
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 border-t border-[#DDD7CC] pt-8">
              {about.metrics.map((m) => (
                <div key={m.label}>
                  <p className="font-display text-[40px] sm:text-[46px] font-semibold text-[#101D32]">
                    {m.value}
                  </p>
                  <p className="mt-1 font-sans text-[13px] font-bold uppercase tracking-[0.14em] text-[#424956]">
                    {m.label}
                  </p>
                </div>
              ))}
          ...
          <div className="flex flex-col justify-between border-t border-[#DDD7CC] pt-8 lg:border-l lg:border-t-0 lg:pl-16 xl:pl-20 lg:pt-0">
            <div>
              <p className="font-sans text-[17.5px] sm:text-[18.5px] leading-[1.8] text-[#424956]">
                {about.body}
              </p>

              <div className="mt-10 border-t border-[#DDD7CC] pt-8">
                <p className="font-sans text-[12.5px] font-bold uppercase tracking-[0.16em] text-[#9C7737] mb-3">
                  Nuestros Principios Rectores:
                </p>
                <p className="font-display text-[18.5px] font-medium leading-[1.6] text-[#101D32]">
                  {about.valuesLine}
                </p>
              </div>
            </div>
            ...
            <div className="mt-12 pt-2">
              <Link
                href="/#areas"
                className="btn-secondary min-h-[52px] px-8 text-[15.5px] inline-flex"
              >
