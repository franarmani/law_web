              ...
              >
                ...
                <div className="hidden lg:grid lg:grid-cols-12 gap-6 items-center">
                  ...
                  <div className="lg:col-span-5 flex items-center gap-5">
                    ...
                    <h3 className="font-display text-[19px] xl:text-[21px] font-semibold leading-tight text-[#101D32] transition-colors duration-200 [@media(hover:hover)]:group-hover:text-[#9A7538] group-focus-visible:text-[#9A7538]">
                      {area.name}
                    </h3>
                  </div>
                ...
                <div className="flex items-center justify-between gap-4 lg:hidden">
                  <div className="flex flex-col min-w-0">
                    <div className="flex items-baseline gap-2">
                      ...
                      <h3 className="font-display text-[16px] min-[375px]:text-[17px] sm:text-[18px] font-semibold leading-snug text-[#101D32] transition-colors duration-200 group-hover:text-[#9A7538]">
                        {area.name}
                      </h3>
                    </div>
